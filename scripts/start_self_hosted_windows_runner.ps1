...
function Fail([string]$Message) {
    throw "HMS-AI-ROUTER self-hosted runner start failed: $Message"
}
...
Write-Host "HMS-AI-ROUTER self-hosted runner foreground qualification mode"
Write-Host "Freeze the exact PR head and review the Windows workflow before starting this runner."
Write-Host "Keep this elevated console open only for the qualification window."
