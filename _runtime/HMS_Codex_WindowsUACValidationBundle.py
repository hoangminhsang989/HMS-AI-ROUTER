...
def session_init(output: Path) -> dict[str, Any]:
    ...
    return {
        ...
        "identity_binding_ready": True, "production_evidence_eligible": False, "windows_runtime_certified": False,
    }
...
def _verify_pair_data(session: dict[str, Any], cancel: dict[str, Any], close: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "identity_binding_required": True, "cryptographic_attestation": False, "production_evidence_eligible": False,
        "canonical_seven_case_certification": False, "windows_runtime_certified": False,
        "production_score_mutation_authorized": False,
    }
...
def synthetic_proof() -> dict[str, Any]:
    ...
    session = {
        ...
        "preflight": {"identity_binding_ready": True},
    ...
    cancel = {
        ...
        "interactive": {"verdict": EXPECTED_CANCEL, "same_token_replay_blocked": True, "uac_prompt_executed": True,
                        "identity_binding_used": True, "effects_executed": False, "closed_pid_count": 0},
    }
    close = {
        ...
        "interactive": {"verdict": EXPECTED_CLOSE, "same_token_replay_blocked": True, "uac_prompt_executed": True,
                        "identity_binding_used": True, "pid_reuse_blocked_by_open_handles": True,
    ...
    checks = {
        ...
        "session_requires_readonly_identity_preflight": "harness.preflight_report()" in impl_src and "identity_binding_ready" in impl_src,
