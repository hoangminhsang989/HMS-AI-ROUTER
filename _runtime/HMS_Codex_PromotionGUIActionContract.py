...
def evaluate_gui_action_contract(report, live_observation, *, reviewer_identity="", reviewer_salt="", lane="", busy=False):
    ...
    return {"product":"HMS-AI-ROUTER","version":VERSION,"suite":"PROMOTION_GUI_ACTION_CONTRACT","policy":policy,
        "form":{"identity_ok":identity_ok,"salt_ok":salt_ok,"lane_ok":lane_ok,"form_ok":form_ok},"buttons":buttons,
        "confirmation_required":any(buttons.values()),"salt_clear_required_after_attempt":True,
...
def synthetic_proof():
    ...
    return {"product":"HMS-AI-ROUTER","version":VERSION,"suite":"PROMOTION_GUI_ACTION_CONTRACT_PROOF","verdict":"PASS" if passed==len(tests) else "FAIL",
